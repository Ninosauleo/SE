...
int getDuplicatesFromProjectString(str projectString) {
    ...
    list[str] stringList = stripComments(projectString);
...
//int getDuplicatesFromProjectString2(str projectString) {
//  list[str] stringList = stripComments(projectString);
//  stringList = stripStringList(stringList);
//  
...
int getDuplicationScore(loc project) {
    ...
    real duplicationPercentage = (duplicatedLocs * 100.0) / locs;
